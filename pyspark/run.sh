...
## copy PySpark code
gsutil cp pagerank.py gs://pagerank/
...
gcloud dataproc jobs submit pyspark --region europe-west1 --cluster cluster-a35a gs://pagerank/pagerank.py -- gs://public_lddm_data/page_links_en.nt.bz2 3
