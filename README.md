...
3. Nous avons constaté des différences notables en terme du temps d'exécution pour une meme configuration d'éxecution. Nous atribuons ce comportaments au disponibilités et état des santés des clusters utilisés aux moments donnés. Afin de minimiser ce bruit dans l'analyse de temps d'exécution, nous recommandons d'exécuter les expériences à plusieurs reprises pour ensuite présenter les résultats moyen, pour chaque configuration.
