...
* Pig bénéficie plus de l'augmentation du nombre de noeuds, on peut apercevoir cela surtout dans l'increment de nombre de noeuds de 4 à 5, où nous pouvons apprécier que les implémentations sur PySpark atteignent un seuil dans leurs temps d'exécution, tandis que le temps d'exécution continue à diminuer pour Pig.
