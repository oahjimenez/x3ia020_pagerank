...
* L'implémentation PySpark avec du partitionnement c'est celle qui performe le mieux en moyen, ensuite Pig et pyspark ont un moyen de temps d'exécution très proche.
