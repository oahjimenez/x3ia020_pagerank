...
* **Données d'entrée**: le dataset [page_links_en.nt.bz2](http://downloads.dbpedia.org/3.5.1/en/page_links_en.nt.bz2), disponible sur le bucket publique gs://public_lddm_data//page_links_en.nt.bz2
