...
* PySpark avec du partitionnement c'est l'implémentation qui performe le mieux en moyen, néanmoins cette implémentation atteint un seuil a un nombre de noeuds 5, ou il est rattrapé par Pig.
