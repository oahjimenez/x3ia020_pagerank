...
Tout d'abord nous présentons les configurations utilisées pour réaliser cette expérience, ensuite on compare les temps d'exécutions du pagerank avec des diagrammes((#2-exécutions-pagerank---pig-vs-pyspark)  ), nous illustrons les meilleurs pagerank(#3-meilleur-pagerank) ). Finalement, nous présentons les [conclusions et récomendations](#4-conclusions-et-recommendations) issues des comparaisons et le déroulement de l'expérience.
