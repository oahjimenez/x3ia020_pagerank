...
* **Nombres de workers**: 2, 3, 4 et 5. Le nombre de noeuds a été choisit en function de la configuration permis dedans la quota.
...
3. Nous avons constaté des différences notables en termes du temps d'exécution pour une même configuration d'exécution. Nous attribuons ce comportement aux disponibilités et état des santés des clusters utilisés aux moments donnés. Afin de minimiser ce bruit dans l'analyse de temps d'exécution, nous recommandons d'exécuter les expériences à plusieurs reprises pour ensuite présenter les résultats moyens, pour chaque configuration.
